...
import metamaskImg from "images/wallet-logo/metamask.svg";
import coinbaseImg from "images/wallet-logo/coinbase-wallet.svg";
import walletConnectImg from "images/wallet-logo/wallet-connect.svg";
...
function FullApp() {
  ...
  return (
    <>
          ...
          {!isHome && (
            <Switch>
              ...
              <Route exact path="/pools">
                <Pools savedSlippageAmount={savedSlippageAmount} setPendingTxns={setPendingTxns} connectWallet={connectWallet} />
              </Route>
      ...
      >
        <p><Trans>Select a wallet to connect</Trans></p>

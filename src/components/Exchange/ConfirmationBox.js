...
import rightArrowIcon from "images/trade/right-arrow-icon.svg";
...
export default function ConfirmationBox(props) {
    ...
    return (
      <div className="Confirmation-box-main">
        ...
        <div className="right-column">
          <div className="left-column">
            <div className="first-line">
              <Trans> {isLong ? t`Long` : t`Short`}</Trans>
            </div>
            <div className="second-line">
              {formatAmount(toAmount, toToken.decimals, 4, true)} {toToken.symbol}
            </div>
  ...
  const renderMarginSection = useCallback(() => {
    return (
      <>
        <div className="margin-selection-component">
          {renderMain()}
          {renderFeeWarning()}
          {renderExistingOrderWarning()}
            ...
            isShort && (
              <div className="short-position">
                ...
                <div className="third-component">
                  <div className="third-component-inner">
                    {showSpread && (
          ...
          {
            isLong && (
              <div className="long-position">
                <div className="second-component">
                  <ExchangeInfoRow label={t`Collateral In`} value={toTokenInfo.symbol} />
  ...
  const renderSwapSection = useCallback(() => {
    return (
      <>
        <div className="swap-section-component">
          {renderMain()}
          {renderFeeWarning()}
          {renderSpreadWarning()}
          {orderOption === LIMIT && renderAvailableLiquidity()}
          ...
          <div className="second-component" >
            ...
            {!isMarketOrder && (
              <div className="Exchange-info-row">
                ...
                <div className="Exchange-info-value">{getExchangeRateDisplay(triggerRatio, fromTokenInfo, toTokenInfo)}</div>
              </div>
            )}
            {showSpread && (
            ...
            {fromTokenUsd && (
              <div className="Exchange-info-row">
                ...
                <div className="Exchange-info-value">{fromTokenUsd} USD</div>
              </div>
            )}
            {toTokenUsd && (
              <div className="Exchange-info-row">
                ...
                <div className="Exchange-info-value">{toTokenUsd} USD</div>
              </div>
            )}
          </div>
    ...
    <div className="Confirmation-box">
      <Modal isVisible={true} setIsVisible={() => setIsConfirming(false)} label={title} allowContentTouchMove>
        <div className="modal-description">
          {
            title == t`Confirm Limit Order` ? 'Please check the information & confirm limit order' :
              title == t`Confirm Swap` ? 'Please check the information & confirm swap' :
                title == t`Confirm Long` ? 'Please check the information & confirm Long Position' :
                  'Please check the information & confirm Short Position'
          }
        </div>

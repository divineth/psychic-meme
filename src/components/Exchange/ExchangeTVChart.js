  ...
  const ExchangeTop = () => (
    <div className="ExchangeChart-top App-box App-box-border" >
      <div className="ExchangeChart-top-inner">
        <div className="chart-token-selector-wrapper">
        ...
        <div className="exchange-chart-stats">
          <div>
            <div className="ExchangeChart-main-price ExchangeChart-info-label">
              {chartToken.maxPrice && formatAmount(chartToken.maxPrice, USD_DECIMALS, 2, true)}
            </div>
            <div className="ExchangeChart-info-label no-margin">
          ...
          <div>
            ...
            <div className={cx('ExchangeChart-info-value', 'change-in-24hours', { positive: deltaPercentage > 0, negative: deltaPercentage < 0 })}>
              {!deltaPercentageStr && "-"}
          ...
          <div>
            ...
            <div className="ExchangeChart-info-value">
              {!high && "-"}

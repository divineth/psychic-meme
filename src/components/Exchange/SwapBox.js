...
import replaceLogo from "images/trade/replace.svg"
import usdtLogo from "images/token-logo/usdt-logo.svg"
import usdLogo from "images/trade/green-dollar.svg"
...
export default function SwapBox(props) {
  ...
  useEffect(() => {
    if (leverageOption > 15) {
      console.log("leverage value:  =========================================")
      toast.warn("Warning: Your risk of liquidation increases as you choose higher leverage. Always manage your exposure to risk.", {
        toastId: 1
      })
      toast.warn("Warning: Your risk of liquidation increases as you choose higher leverage. Trade with caution!!!.", {
        toastId: 2
      })
    }
  }, [leverageOption > 15,]);
      ...
      <div className="Exchange-swap-box-inner">
...

        {
          showTriggerPriceSection && (
            <div className="Exchange-swap-section Flux-swap-section">
              <div className="Exchange-swap-section-bottom Flux-swap-section-top">
                <div className="Exchange-swap-input-container">
                  <div className="Exchange-swap-input-number">
                    <input
                      type="number"
                      min="0"
                      placeholder="0.0"
              ...
              <div className="Exchange-swap-section-top Flux-swap-section-bottom">
                <div className="muted">
                  <Trans>Price</Trans>
                </div>
                {/* <div
            ...
            <React.Fragment>
              <div className="Exchange-swap-section Flux-swap-section">
                <div className="Exchange-swap-section-bottom Flux-swap-section-top">
                  ...
                  <div className="from-token-selector-wrapper token-selctor-wrapper">
                    <TokenSelector
                      label={t`Pay`}
                      chainId={chainId}
                ...
                <div className="Exchange-swap-section-top Flux-swap-section-bottom">
                  ...
                  <div className="Exchange-swap-ball-container" onClick={switchTokens}>
              ...
              <div className="Exchange-swap-section Flux-swap-section second-swap-section">
                <div className="Exchange-swap-section-bottom Flux-swap-section-top">
                  <div className="Exchange-swap-input-container">
                    <div className="Exchange-swap-input-number">
                      <input
                  ...
                  <div className="to-token-selector-wrapper token-selctor-wrapper">
                    <TokenSelector
                      label={getTokenLabel()}
                      chainId={chainId}
                ...
                <div className="Exchange-swap-section-top Flux-swap-section-bottom">
                  <div className="muted">
                    ...
                    {!toUsdMax && getToLabel()} {': 0 USD'}
                    {toBalance && (
                      <div className="muted clickable" onClick={setFromValueToMaximumAvailable}>
                        <Trans>Balance: {formatAmount(toBalance, toToken.decimals, 4, true)}</Trans>
                      </div>
                    )}
                  </div>
                </div>
                ...
                isLeverageSliderEnabled && (
                  ...
                  >
                    <Slider
                      ...
                      className={`${Math.round(leverageOption) <= 15 ? 'green-background' : 'red-background'}`}
                    />
                  </div>
                )
              }
...

              {
                isShort && (
                  <div className="Exchange-info-row">
                    ...
                    <div className="align-right token-selctor-wrapper">
                      <TokenSelector
        ...
        {
          isStopOrder && (
            <div className="Exchange-swap-section Flux-swap-section Exchange-trigger-order-info">
              <div className="title">
...

      {
        isSwap && (
          <div className="Exchange-swap-market-box App-box App-box-border">
            ...
            <div className="Exchange-info-row-group">
              <div className="Exchange-info-row">
                <div className="Exchange-info-label">
              ...
              <div className="Exchange-info-row">
                ...
                <div className="align-right al-swap">
                  <div className="Tooltip-handle">
                    {formatAmount(maxSwapAmountUsd, USD_DECIMALS, 2, true)}
                  </div>
                  {/* <Tooltip
          ...
          <div className="Exchange-swap-market-box App-box App-box-border">
            ...
            <div className="Exchange-info-row-group">
              ...
              <div className="Exchange-info-row">
                ...
                <div className="align-right">
                  <div className="Tooltip-handle">
                    {formatAmount(exitMarkPrice, USD_DECIMALS, 2, true)}
                  </div>

...
import chatbotLogo from "images/mainpage/chatbot-logo.svg";
  ...
  return (
    <div className="Footer-container">
      <div className="Footer">
        <img className="mobile-img" src={logo} />
        <div>
          <p><a href='https://linktr.ee/FluxExchange'>About us</a></p>
          <p><a href='https://linktr.ee/FluxExchange'>Announcementss</a></p>
          <img className="web-img" src={logo}></img>
          <p><a href='https://linktr.ee/FluxExchange'>Blog Page</a></p>
          <p><a href='https://linktr.ee/FluxExchange'>Docs</a></p>
        </div>

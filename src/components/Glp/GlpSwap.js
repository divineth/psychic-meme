...
import arrowIcon from "images/trade/replace.svg"
...
export default function GlpSwap(props) {
  ...
  const tabLabel = isBuying ? t`Buy Flux` : t`Sell Flux`;
  ...
  const getPrimaryText = () => {
    ...
    return isBuying ? t`Buy Flux` : t`Sell Flux`;
  };
  ...
  return (
    <div className="GlpSwap">
      ...
      <div className="GlpSwap-backdrop" onClick={hideGlpSwap()}>
      </div>
      <div className="GlpSwap-content">

        <div className="GlpSwap-box App-box">
          <Tab
            options={[t`Buy Flux`, t`Sell Flux`]}
            option={tabLabel}
        ...
        <div className="App-card GlpSwap-stats-card">
          ...
          <div className="App-card-content up-content">
            ...
            <div className="App-card-row">
              ...
              <div className="value">
                {formatAmount(glpBalance, GLP_DECIMALS, 4, true)} FluxLP ($
          ...
          {/* <div className="App-card-divider" /> */}
          <div className="App-card-content down-content">
            {/* {!isBuying && (
              <div className="App-card-row">
                <div className="label">
            ...
            <div className="App-card-row">
              <div className="label total-supply">
                <Trans>Total Supply</Trans>
              </div>
              <div className="value total-supply">
                <Trans>
                  {formatAmount(glpSupply, GLP_DECIMALS, 4, true)} Flux ($
      ...
      {/* <div className="Tab-title-section">
        ...
        {isBuying && (
          <div className="Page-description">
            <Trans>
              Fees may vary depending on which asset you use to buy Flux. <br />
lux          Enter the amount of GLP you want to purchase in the order form, then check here to compare fees.
            </Trans>
          </div>
        )}
        {!isBuying && (
          <div className="Page-description">
            <Trans>
              Fees may vary depending on which asset you sell FLU for. <br />
      ...
      <div className="liquidity-overview-container">

        <caption className="App-card-title">
          <Trans>Liquidity Overview</Trans>
        </caption>

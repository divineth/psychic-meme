import { ARBITRUM, AURORA, AVALANCHE, FANTOM, FANTOM_TESTNET } from "config/chains";
...
export const availableNetworksForChart = [ARBITRUM, AVALANCHE, FANTOM, FANTOM_TESTNET, AURORA,];

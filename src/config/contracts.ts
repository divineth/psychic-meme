...
import { ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, AVALANCHE_FUJI, MAINNET, TESTNET, FANTOM, FANTOM_TESTNET } from "./chains";
...
const CONTRACTS = {
  ...
  [AVALANCHE]: {
    ...
    RewardRouter: "0x82147C5A7E850eA4E28155DF107F2590fD4ba327", // FOR GMX
  ...
  [FANTOM]: {
    // fantom
    Vault: "0x4a09C14CB7F09B2418eE264c8B8228352dEA3Fed",
    Router: "0xBdB0E7469b52bDBE95739Ce8E6EA02c11f2c5353",
    VaultReader: "0xf6C1A21Df497c6AFa489391509F9B2d1831e83A1",
    Reader: "0x1fADeaE7DcD993312b50389730714A5CfBE2Ab05",
    GlpManager: "0xbC4C0511eD21B7F55C66A8aB66166fF4A6924F0a",
    RewardRouter: AddressZero, // FOR GMX
    GlpRewardRouter: "0xB275e66237fb7f02f72c13CB7528Ed1665cde5A8",
    RewardReader: "0x17cD22f35793aE460627F1928b5E1B459F69ab98",
    NATIVE_TOKEN: "0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83",
    GLP: "0x7C2AB8d6ed8Fdd02cf714D0647333f9f7ACD9B5a",
    GMX: AddressZero,  // FOR GMX
    ES_GMX: AddressZero,
    BN_GMX: AddressZero,
    USDG: AddressZero,
    FUSD: "0x9120dAe68b8644C73452CCA9A79fEdde4e8C318b",
    ES_GMX_IOU: AddressZero, // placeholder address

    StakedGmxTracker: AddressZero,
    BonusGmxTracker: AddressZero,
    FeeGmxTracker: AddressZero,
    StakedGlpTracker: AddressZero,
    FeeGlpTracker: "0x93eb11ab63b476eB6c28FEf2C323850B0d55d6D4",

    StakedGmxDistributor: AddressZero,
    StakedGlpDistributor: "0xBF1Bb6AdC5Fa26d109BFB8AB85227b188844E7Df",

    GmxVester: AddressZero,
    GlpVester: AddressZero,

    OrderBook: "0x99B95393E7CE718A59035FC9f7ebAd234aC28662",
    OrderExecutor: "0x99B95393E7CE718A59035FC9f7ebAd234aC28662",
    OrderBookReader: "0xF5767063c3f5d3c656ddb4043792969992d85c67",

    PositionRouter: "0xF2198E3408A0ea2BD0ff0Fd967cE871C4D36951a",
    PositionManager: "0x6Acee943083b0d0e0632Ad12Dc4C6300B285D96B",

    TraderJoeGmxAvaxPool: AddressZero,
    ReferralStorage: "0x31a56817c7B56800ad9A6b3ac3ae895bC4568412",
    ReferralReader: "0x7De69dAf45D5d465c17b23a25Cf740C90a16AeA0",
  ...
  [FANTOM_TESTNET]: {
    // fantom
    Vault: "0x075eEC21519C93BBE7AaE04C9cA658a795E6950C",
    Router: "0x2e501D7833d83c33461D22d9Baf5bD39604D01be",
    VaultReader: "0x77A80037fab408794d85a879DA795CD8caC02212",
    Reader: "0xb620d220568700c81e28239D46Fe914F0F7B0127",
    GlpManager: "0x3331629773B832Ef0C6220A569E982595cDa9F5f",
    RewardRouter: AddressZero, // FOR GMX
    GlpRewardRouter: "0xBFeB57305f813270F2eD9e780345cA52DE79c2D9",
    RewardReader: "0xad3cEa362f33A3cAB2Feb0212b1F43e46AFDFAa0",
    NATIVE_TOKEN: "0xcD6757E91769c3DB0980369485a9CF8B9198Da5B",
    GLP: "0xB6AaE10802be8Ee81eC3a07ffBFF8BCDDcA1142F",
    GMX: AddressZero,  // FOR GMX
    ES_GMX: AddressZero,
    BN_GMX: AddressZero,
    USDG: AddressZero,
    FUSD: "0xaEbD0d3D87Ac79F24B35f1fF403ED039a594aF47",
    ES_GMX_IOU: AddressZero, // placeholder address
    ...
    FeeGmxTracker: AddressZero,
    StakedGlpTracker: AddressZero,
    FeeGlpTracker: "0xad3cEa362f33A3cAB2Feb0212b1F43e46AFDFAa0",

    StakedGmxDistributor: AddressZero,
    StakedGlpDistributor: "0x2292B43Ab7C03fb9180D8dDD818a3e22Ce2d7620",

    GmxVester: AddressZero,
    GlpVester: AddressZero,

    OrderBook: "0x27992523376fe65aF0aef26e132ce2508266571E",
    OrderExecutor: "0x99B95393E7CE718A59035FC9f7ebAd234aC28662", // ===============
    OrderBookReader: "0x74c9404b5DC0DbB41fFBB4Ca7469a1C1b99653fa",

    PositionRouter: "0xE2e8C3D83295c4994AEBdB5e067538EB684e1F4e",
    PositionManager: "0x3814FFc4DEf2feE71EC428E5900214618298035A",

    TraderJoeGmxAvaxPool: AddressZero,
    ReferralStorage: "0x39f18b7b277dd9473d4506DBf7B96cb1EB207fA7",
    ReferralReader: "0x089d96a289c9BE2958167877Fe7fE2E6838c5037",

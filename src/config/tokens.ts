...
import { ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, AVALANCHE_FUJI, MAINNET, TESTNET, FANTOM, FANTOM_TESTNET, AURORA } from "./chains";
...
export const TOKENS: { [chainId: number]: Token[] } = {
  ...
  [FANTOM_TESTNET]: [
    ...
    },
    {
      ...
      symbol: "WFTM",
      decimals: 18,
      address: "0xcD6757E91769c3DB0980369485a9CF8B9198Da5B",
      isWrapped: true,
      baseSymbol: "FTM",
      imageUrl: fantomLogo,
    },
    {
      name: "Ethereum (WETH.e)",
      symbol: "ETH",
      address: "0x6292Bfdb1041bb948d9Cc1D6b7e9219326E61b89",
      decimals: 18,
      isShortable: true,
      imageUrl: ethereumLogo,
    },
    {
      name: "Bitcoin (WBTC.e)",
      symbol: "WBTC",
      address: "0xc6B94F1469f4eCAd9da90A00561DCB1065A9C523",
      decimals: 8,
      isShortable: true,
      imageUrl: bitcoinLogo,
    },
    {
      name: "USD Coin",
      symbol: "USDC",
      address: "0x38BE423CC9064DE4Fa9C1C436888B655078f3879",
      decimals: 6,
      isStable: true,
      imageUrl: usdcLogo,
    },
    {
      ...
      symbol: "DAI",
      decimals: 18,
      address: "0x9eA73c29B30947fe09CE3Fab1e5ac4E216B7C4c4",
      isStable: true,
      imageUrl: daiLogo,
    },
  ],
...
export const ICONLINKS = {
  ...
  [FANTOM]: {
    GLP: {
      fantom: "https://ftmscan.com/address/0x7c2ab8d6ed8fdd02cf714d0647333f9f7acd9b5a",
    },
    FTM: {
      fantom: "https://www.coingecko.com/en/coins/fantom",
    },
    ETH: {
      coingecko: "https://www.coingecko.com/en/coins/weth",
    },
  ...
  [FANTOM_TESTNET]: {
    GLP: {
      fantom: "https://testnet.ftmscan.com/address/0xB6AaE10802be8Ee81eC3a07ffBFF8BCDDcA1142F",
    },
    FTMX: {
      fantom: "https://www.coingecko.com/en/coins/fantom",
    },
...
const CHAIN_IDS = [MAINNET, TESTNET, ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, AVALANCHE_FUJI, FANTOM, FANTOM_TESTNET,/* AURORA,*/];
...
export function getWhitelistedTokens(chainId: number) {
  return TOKENS[chainId].filter((token) => token.symbol !== "FUSD");
}

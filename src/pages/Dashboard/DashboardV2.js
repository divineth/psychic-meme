...
import upLogo from "images/mainpage/up.svg"
import downLogo from "images/mainpage/down.svg"
import fluxLogo from "images/mainpage/flux-logo.svg"
import priceLogo from "images/mainpage/price.svg"
import supplyLogo from "images/mainpage/supply.svg"
import totalStakedLogo from "images/mainpage/total-staked.svg"
import marketCapLogo from "images/mainpage/market-cap.svg"
import stableCoinLogo from "images/mainpage/stable-coin.svg"
          ...
          <div className="section-title-block">
            ...
            <div className="section-title-content">
              <div className="Page-title">
                ...
                {/* <img width="24" src={currentIcons.network} alt="Network Icon" /> */}
              </div>
              <div className="Page-description">
                <Trans>
                  {chainName} Total Stats start from {totalStatsStartDate}. For detailed stats:
                </Trans>{" "}
          ...
          <div className="DashboardV2-content">
                ...
                >
                  <Carousel.Item>
                    <div className="statistics-card">
                      ...
                      <div>
                        <p>
                          {`$${formatAmount(tvl, USD_DECIMALS, 0, true)}`}
                        </p>
                        <img src={upLogo} />
                      </div>
                    </div>
                  ...
                  <Carousel.Item>
                    <div className="statistics-card">
                      ...
                      <div>
                        <p>
                          {`$${formatAmount(currentVolumeInfo?.[chainId]?.totalVolume, USD_DECIMALS, 0, true)}`}
                        </p>
                        <img src={downLogo} />
                      </div>
                    </div>
                  ...
                  <Carousel.Item>
                    <div className="statistics-card">
                      <p>
                        <Trans>Fees since 23 Nov 2022</Trans>
                      </p>
                      <div>
                        <p>
                          $2,070,609.82
            ...
            <div className="statistics-wrapper">
              <div className="statistics">
                ...
                <div className="statistics-card-continer">
                  <Carousel
                    cols={3}
                    rows={1}
                    gap={20}
            ...
            <div className="Tab-title-section">
              ...
              <div className="Page-description">
                <Trans>Platform and FLU index tokens.</Trans>
              </div>
            </div>

            <div className="tokens-statistics-wrapper">
              <div className="tokens-statistics">
                <div
                  className="flu-menu-wrapper"
                >
                  <Menu>
                    <Menu.Button as="div">
                ...
                <div className="tokens-container">
                  <div className="tokens">
                    <img src={priceLogo} />
                    <p> <Trans>Price</Trans> </p>
                    <div>
                      <p>${formatAmount(glpPrice, USD_DECIMALS, 3, true)}</p>
                      <p></p>
                    </div>
                  </div>
                  <div className="tokens">
                    <img src={supplyLogo} />
                    <p> <Trans>Supply</Trans> </p>
                    <div>
                      <p>{formatAmount(glpSupply, GLP_DECIMALS, 0, true)} </p>
                      <p>FLU</p>
                    </div>
                  </div>
                  <div className="tokens">
                    <img src={totalStakedLogo} />
                    <p> <Trans>Total Staked</Trans> </p>
                    <div>
                      <p>${formatAmount(glpMarketCap, USD_DECIMALS, 0, true)}</p>
                      <p></p>
                    </div>
                  </div>
                  <div className="tokens">
                    <img src={marketCapLogo} />
                    <p> <Trans>Market Cap</Trans></p>
                    <div>
                      <p>${formatAmount(glpMarketCap, USD_DECIMALS, 0, true)}</p>
                      <p></p>
                    </div>
                  ...
                  <div className="tokens">
                    <img src={stableCoinLogo} />
                    <p> <Trans>Stablecoin %</Trans> </p>
                    <div>
            ...
            <div className="DashboardV2-token-cards">
              ...
              <div className="token-table-wrapper App-card">
                <caption className="App-card-title">
                  <Trans>FLU Index Composition</Trans>
                ...
                <table className="token-table">
                  ...
                  <tbody>
                    {visibleTokens.map((token) => {
                      ...
                      const tokenImage = token.symbol.toLowerCase() + "Logo";
                      return (
                        <tr key={token.symbol}>
                          <td>
                            <div className="token-symbol-wrapper">
                              <div className="App-card-title-info">
                                <div className="App-card-title-info-icon">
                                  <img src={logoNameArr[tokenImage]} alt={token.symbol} />
                                </div>
                                <div className="App-card-title-info-text">
                                  <p className="App-card-info-title">{token.name}</p>
                                  <p className="App-card-info-subtitle">{token.symbol}</p>
                                </div>
                                {/* <div>

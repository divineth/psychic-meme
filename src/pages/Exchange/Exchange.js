    ...
    return (
      <div>
        <div className="Exchange-list-tab-container">
          ...
          />
          <div className="Exchange-should-show-position-lines-wrapper">
      ...
      <div className="Exchange page-layout">
        ...
        <div className="Exchange-content">
          ...
          <div className="Exchange-main">
            <div className={`Exchange-chart Exchange-chart-mobile ${window.innerWidth < 1100 ? '' : 'hidden'}`}>
              {renderChart()}
              <div className="Exchange-lists large">{getListSection()}</div>
            </div>
            <div className="Exchange-swapbox-wrapper">
              <SwapBox
                pendingPositions={pendingPositions}
                setPendingPositions={setPendingPositions}
                setIsWaitingForPluginApproval={setIsWaitingForPluginApproval}
            ...
            <div className={`Exchange-chart Exchange-chart-desktop ${window.innerWidth > 1100 ? '' : 'hidden'}`}>
